        ...
        <div className="flex h-20 items-center justify-between">
          ...
          <div className="hidden xl:flex items-center gap-3">
            <a
              ...
              className="flex items-center gap-2 text-sm font-semibold text-white/70 hover:text-jar-orange transition-colors"
            >
              <Phone className="w-4 h-4" />
              <span className="hidden 2xl:inline">06 00 00 00 00</span>
            </a>
            <Link
              href="/contact"
