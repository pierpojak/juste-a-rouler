...
export default function VehicleDetailClient({ slug }: { slug: string }) {
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-jar-offwhite pt-32 flex flex-col items-center">
        <Loader2 className="w-10 h-10 text-jar-orange animate-spin mb-4" />
        <p className="text-jar-gray text-sm">Chargement du véhicule...</p>
      </div>
    );
  }
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            >
              ...
              <p className="text-jar-gray leading-relaxed whitespace-pre-line">{vehicle.description}</p>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-jar-gray-light text-sm mb-3">
                      Ce véhicule est couvert par notre garantie mécanique.
